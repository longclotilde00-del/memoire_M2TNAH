...
le lien de cette sous partie = peut être faire du logiciel une interface semblable à celle des applications du web : c'est ce vers quoi tend skinsoft. 
Pour les archives audiovisuelles : spécificités : visionneuse vidéo, visualisation en graphe, recherche par image...
...
L'utilisateur peut créer des marqueurs sur des "imagettes", qui sont en réalité des images clés, ces marqueurs créent des "time-codes" au sein desquels il est possible de saisir du texte. À partir de l'outil, il est possible d'exporter les imagettes, le texte annoté, et des statistiques sur le contenu. 
...
Faire le lien avec la recherche par images déjà en place dans l'application

Recherche en langage naturel en cours de développement et développé au cours du stage : quel lien avec l'implémentation d'algorithmes automatisés ? ESt ce que le NLP pourrait aider à présenter les nouvelles entités : segments ? 
articles sur ce que permet le NLP 
