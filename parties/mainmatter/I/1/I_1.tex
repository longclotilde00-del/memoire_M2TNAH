...
Cette partie s’attache à définir le \gls{FRBR} (\textit{Functionnal Requirements for Bibliographic Records}) comme modèle de données conçu pour le milieu des bibliothèques, fondé sur les besoins utilisateurs.
Structuration de la description en niveaux afin d'améliorer l'identification des documents. 
