...
Les technologies appliquées à l'analyse de contenus vidéo et audio, comprenant la \gls{Vision par ordinateur} et la reconnaissance de discours automatique (ASR) sont globalement désignées sous le terme de \gls{Traitement audiovisuel}\footcite{noord2021}.
