...
Dès 1998, le chercheur Bruno Bachimont exprime la manière dont la manipulation des contenus audiovisuels, au sein des pratiques documentaires, est contrainte par leur nature temporelle, fixée sur un support. En effet, les documents audiovisuels comprennent "des images et / ou des sons reproductibles réunis sur un support matériel dont : l’enregistrement, la transmission, la perception et la compréhension exigent le recours à un dispositif technique" \footcite{zotero-item-772}. 
Ainsi, contrairement aux documents imprimés et textuels dont la forme rend accessible le contenu, les supports audiovisuels sont opaques et rendent la description documentaire fastidieuse, et d'autant plus leur indexation, qui rend la description accessible et exploitable par des utilisateurs \footcite{bachimont}. Les institutions patrimoniales préservatrices de fonds audiovisuels sont, d'une part, confrontées à la complexité d'indexer ce type de contenu et d'autre part, au volume grandissant de ces collections. En effet, la qualité reproductible des documents audiovisuels densifie les collections patrimoniales, et il devient difficile de traiter manuellement les contenus audiovisuels à des fins descriptives. 
...
Pourtant, une réelle nécessité subsiste concernant ce type d'archives puisque, nécessitant du matériel de lecture, on privilégie la "consultation indirecte", via l'indexation de description, plutot qu'une "consultation directe", nécessitant du matériel spécifique \footcite{bachimont}. (face à la masse des documents : décrire de manière précise des documents sélectionnés : séquences, plutôt que de tout décrire grossièrement) Or, pour éviter une consultation directe, la description doit détailler le caractère temporel du contenu et sa syntaxe, notamment constitué d'unités telles que les plans ou les séquences, permettant de concrétiser une "navigation" et un "parcours". L'indexation manuelle ne peut pas atteindre ce niveau de précision, qui supposerait un temps dédié considérable. 
Afin de gérer ces complexités, la description spécifique de ce type de document, et d'y donner accès, le logiciel de gestion des collections joue un rôle d'intermédiaire primordial. Dispositif technique dans lequel s'inscrit l'indexation. 
Permettant de gérer des "informations structurées" sur les objets conservés, et donc de concrétiser l'indexation \footcite{zotero-item-766}. permet précisément d'intelligibiliser un objet au sein d'un système de gestion des collections et de le rendre repérable et interrogeable auprès de l'utilisateur.
Il permet en effet d'offrir une interface conforme aux normes de description et un modèle de données, qui organise la description en couches intelligibles et interreliées. 
Toutefois, les complexités d'indexation des documents audiovisuels subsistent, le logiciel ne permet pas de réduire le temps de description du contenu précis. 
Dans ce contexte, le développement de fonctionnalités innovantes offre des potentialités d'automatiser certaines pratiques documentaires, dont l'indexation. Particulièrement intéressant pour les documents audiovisuels dont la nature temporelle ralentit considérablement cette tâche, qui implique la lecture du flux temporel et son analyse. l'automatisation par des outils d'intelligence artificielle permettrait jutement de lire et d'analyser le flux vidéo dans le même temps, afin d'en décrire précisément les unités, dont les séquences. et d'y donner largement accès 
Le logiciel de gestion des collections aurait un rôle pivot dans la proposition de relles fonctionnalités à ses utilisateurs préservateurs de documents audiovisuels. 
...
C'est précisément cette double difficulté qui anime l'étude de ce mémoire de recherche, réalisé dans le cadre d'un stage de six mois au sein de l'entreprise Skinsoft, éditrice de solutions logicielles de gestion des collections. Effectué au sein de l'équipe métier, forte de propositions de  fonctionnalités innovantes adaptées aux besoins des clients institutionnels, ce stage se porte spécifiquement sur l'amélioration d'un espace de travail dédié à la gestion des archives audiovisuelles (S-movies), fondé sur le FRBR, à travers le projet d'automatiser certaines tâches d'indexation à l'aide de l'intelligence artificielle. Les réflexions et observations d'un point de vue métier qui ont traversé ce stage constituent le point de départ de ce mémoire, dont l'étude examine les conditions de faisabilité et les modalités d'intégration d'une indexation automatique appliquée à l'audiovisuel au sein d'un système de gestion de collections fondé sur une modélisation adaptative du FRBR. Non expérimenté pendant le stage, cette étude examine les enjeux d'une telle mise en place et imagine l'implémentation du processus au sein du logiciel en accord avec les besoins utilisateurs.
