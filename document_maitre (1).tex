...
\usepackage[toc=true, acronym]{glossaries} %chargement du package acronym pour inclure à mon glossaire une liste d'acronymes qui e nécessitent pas de définition
\makeglossaries
...
%\input{chapitres/mainmatter/introduction.tex}
...
\input{parties/backmatter/annexes.tex}
