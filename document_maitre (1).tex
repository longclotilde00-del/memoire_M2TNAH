...
%intro partie
Cette seconde partie est consacrée à la mise en œuvre theorique d'une chaine de traitement automatique pour la segmentation en séquences du flux audiovisuel, et l'indexation de ces séquences par mots-clés. L'enjeu fondamental de notre réflexion est d'adapter des outils techniques fondés sur l'intelligence artificielle, tout en prenant en compte les exigences de structure documentaire, ainsi que la complexité des archives audiovisuelles.

Le premier chapitre analyse la mise en place théorique d'une segmentation automatique à travers l'outil \gls{pyscene}, fondé sur la \gls{Vision par ordinateur}. Le second chapitre analyse par ailleurs la description automatique des séquences produites via des mots-clés, à l'aide de l'outil \gls{yolo}. Nous évaluerons les besoins d'entraînement de ce modèle, fondé sur un réseau de neurones convolutif, ainsi que la mise en place d'un dispositif de validation technique pour les prédictions produites. Enfin, nous évaluerons les enjeux de reversement des données produites au sein du modèle de données décrit en première partie, nécessitant une supervision de l'utilisateur à chaque étape. 
