...
\appto\frontmatter{\pagestyle{fancy}%
	\renewcommand{\chaptermark}[1]{\markboth{\small\textit{\MakeUppercase{#1}}}{}}% ne pas faire apparaître de <<numéro>> de chapitre dans les chapitres non numérotés (front: l'introduction, els remerciement, etc)
}

%% réglages propres à mainmatter

\appto\mainmatter{
\renewcommand{\chaptermark}[1]{\markboth{\small\chaptername~\thechapter\ -- \textit{\MakeUppercase{#1}}}{}}%%faire apparaître dans les headers les sections en  petit et en italiques
...
\appto\appendix{
\renewcommand{\chaptermark}[1]{\markboth{\small Annexe~\thechapter\ -- \textit{\MakeUppercase{#1}}}{}}%%faire apparaître dans les headers le nom des annexes
	%\renewcommand{\chaptermark}[1]{}%Commenter la ligne précédente et mettre celle-ci pour ne pas avoir le titre des chapitres  dans le header
}
...
\usepackage[automake, toc=true, acronym, sort=use]{glossaries} %chargement du package acronym pour inclure à mon glossaire une liste d'acronymes qui e nécessitent pas de définition
...
} %affichage des titres de chapitre troplongs dans les entêtes 
...
\begin{document}
	\begin{titlepage}
		...
		%selon le cas
			...
			\bigskip
			\begin{LARGE}
				\textbf{L'enjeu du modèle de données au sein d'un logiciel de gestion des collections - le cas S-Movies chez Skinsoft}\\
			\end{LARGE}
...
%	\include{chapitres/frbr.tex}
%	\include{chapitres/frbr_archives_audiovisuelles.tex}
%	\include{chapitres/indexation_frbr.tex}
