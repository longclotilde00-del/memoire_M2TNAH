...
\usepackage{float} %pour la position des tableaux 
\usepackage{multirow}
\usepackage{array}
...
Ce mémoire traite du suivi des productions au sein d’Ubisoft et s’appuie sur des données et des processus internes à l’entreprise. En raison de leur nature sensible et stratégique,
certaines informations, outils ou détails techniques ne peuvent être divulgués dans leur intégralité.
Les analyses présentées respectent les contraintes de confidentialité imposées par l’entreprise, et les exemples fournis, notamment les extraits de code en annexe, ont été adaptés
afin de préserver la propriété intellectuelle et les secrets industriels. Ainsi, les noms de tables,
variables ou procédures ont été anonymisés, et les processus décrits le sont à un niveau conceptuel, sans entrer dans des spécificités opérationnelles réservées à un usage interne. Ce travail
reste néanmoins représentatif des enjeux et des méthodes abordés, et permet d’illustrer les
défis liés à la qualité des données dans un contexte industriel complexe.
...
\part{Indexer les archives audiovisuelles}
\input{parties/mainmatter/I/1/I_1.tex}
\input{parties/mainmatter/I/2/I_2.tex}
\input{parties/mainmatter/I/3/I_3.tex}

	
\part{Implémenter l’indexation automatique des archives audiovisuelles au sein d’une remodélisation du FRBR}
...
\newpage{\pagestyle{empty}\cleardoublepage}
%\include{chapitres/mainmatter/conclusion.tex}
